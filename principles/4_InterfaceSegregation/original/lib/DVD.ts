...
interface IHasActors {
  actors: Array<string>;
}

export class DVD implements ILibraryItem, IHasDuration, IHasActors {
  ...
  constructor({ libraryId, title, checkOutDurationInDays=14, borrower='', borrowDate }: ILibraryItemInput & IHasDuration) {
