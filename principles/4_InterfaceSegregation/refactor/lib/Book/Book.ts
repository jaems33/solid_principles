import { IBorrowableBook } from './IBorrowableBook';

export class Book implements IBorrowableBook {
  ...
  constructor(libraryId, title, author, pages, checkOutDurationInDays=14, borrower='', borrowDate) {
